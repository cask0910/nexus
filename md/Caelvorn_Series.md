...
| Book 2: Mira × Cask | ✍️ 尾段写作 | **Ch1-31已定稿 · Ch32 Stay 草稿待审**（34章尾段·结构已落节拍表）· 节拍表34章终版 ✅ |
...
**最新：** **Ch32 Stay 草稿待审**（09-15 · Cask POV · 作者自推草稿→我按 Ch31 段落节奏重排+去AI腔8处 · POV 由 Mira 改为 Cask）· Ch31 Wanting 定稿（09-15 作者 `a3b7051`）· Ch30-Ch29 定稿 · 34章尾段结构已定（下一章 Ch33 The Dream / Ch34 Epilogue）· 旧屋 canon（Solan 接位子前那几年住·她三岁搬家·十五岁要来做账）· 系列总览 Solan 年龄 38→约55 · 节拍表 §0-8 ✅

### 第一幕：回来了，但回来之后呢 (Ch1-8) — ✅ 全部扩写完成

- [x] Ch1 回程 | Mira POV | **扩写完成**（~2,000词）
- [x] Ch2 果然去了 | Cask POV | **扩写完成**（~1,800词）
- [x] Ch3 三分钟 | Mira POV | **扩写完成**（~2,000词）
- [x] Ch4 母亲的厨房 | Mira POV | **扩写完成**（~1,900词·新增）
- [x] Ch5 行前 | Cask POV | **扩写完成** · 时间线修复（Cask收信→见面隔两个月）
- [x] Ch6 第一次见面 | Mira POV | **扩写完成**
- [x] Ch7 暗号 | Cask POV | **扩写完成**（+320词冲2k目标）
- [x] Ch8 Selene要走了 | Mira POV | **扩写完成**
...
- [x] Ch23 情绪最低点 | Mira POV | **定稿**（Ordinary · 1972词 · 33baa48）
- [x] Ch24 她问他 | Cask POV | **定稿**（Enough · 作者更名）· 狼的陪伴戏 · 夜别两问 · 牛奶 He→She 修正
- [x] Ch25 闲言碎语 | Mira POV | **定稿**（Plain）· 黎明独处 · 闲话生态（Bronwen/Caddoc）· 山楂树Lena对比 · 明文信
- [x] Ch26 她选了 | Mira POV | **定稿**（Held）· 提神香囊伏笔 · Solan台词B · _Accepi_ 补答Ch19

### 第三幕：说出来 (Ch27-34 · 2026-09-08 作者定：34章终版 · 尾段六章 Ch29-34)
...
- [x] Ch31 Wanting | Mira POV | ✅ **定稿**（09-15 作者 `a3b7051` · 2053词——旧屋近道/时间盒子四样/拆温泉封条/她主动吻）
- [ ] Ch32 Stay | **Cask POV** | 🕐 **草稿待审**（09-15 `e5e3f8d` · 2457词 · 作者稿——POV 作者改（"Ch31已把Mira说满"）/章题Chosen→Stay/排版对齐前章/去AI腔8处）
- [ ] Ch33 The Dream | Cask POV | ⬜ 未写 · 节拍✅（老婆孩子热炕头·We need another room）
- [ ] Ch34 Epilogue | 双视角 | ⬜ 未写 · 节拍✅（木雕/香囊双向·笑点B回响）
...
- [ ] Ch33-34 英文扩写（Ch32 Stay 草稿待审 · 下一章 **Ch33 The Dream** · Cask POV）
...
跨书接口：
- Selene已从Ashmark离开 → 前往Frostveil
- Corvan的牺牲触发Ashmark权力重组
- Vael前Luna之死的最后一块拼图在Selene手里
...
**状态：** 框架待展开 · 男性向
**核心：** 事业线为主，感情线为辅 · 系列最轻松一本
**关键点：** Garret拒绝政治婚约被驱逐 · 从零重建 · Vesna谋士/军师 · **拆 Ironbone 铁器家族（=Cask 生父家族，2026-08-25 定）**

- [ ] 框架文档
- [ ] 人物卡 (Garret, Vesna — 均待完成)
- [ ] 节拍表
- [ ] Blurb
...
### Book 1 → Book 2
- [x] Selene对Mira说 "Wherever you go, you deserve to be treated well." → Book 3回响
- [x] Cask的信（Transmissum暗号，Mira回Accepi）→ Ch13-14 定稿
...
### Book 3 → Book 4
- [ ] Corvan牺牲 → Ashmark权力重组 → Nyra情报操盘手角色放大
- [ ] Nyra孩子线索浮现

### Book 3&4 → Book 5
- [ ] Dawnwhisper旧人线索 → Vesna出场
- [ ] Vesna与Selene的相遇
